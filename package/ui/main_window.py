...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/rpi.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.button_enable = QtWidgets.QPushButton(self.centralwidget)
        self.button_enable.setCheckable(True)
        self.button_enable.setObjectName("button_enable")
        self.horizontalLayout_3.addWidget(self.button_enable)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/load-file-option.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_load.setIcon(icon1)
        self.action_load.setObjectName("action_load")
        self.action_save = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/save-file-option.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_save.setIcon(icon2)
        self.action_save.setObjectName("action_save")
        self.action_exit = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/exit-to-app-button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_exit.setIcon(icon3)
        self.action_exit.setObjectName("action_exit")
        self.action_about = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/information.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_about.setIcon(icon4)
        self.action_about.setObjectName("action_about")
        self.action_license = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/agreement.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_license.setIcon(icon5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_enable.setText(_translate("MainWindow", "Enable"))
